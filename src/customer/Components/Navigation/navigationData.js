            ...
            sections: [
                {
                    ...
                    items: [
                        ...
                        { name: 'Women Jeans', id: 'women_jeans', href: `{women/clothing/women_dress}` },
                        { name: 'Lengha Choli', id: 'lengha_choli', href: `{women/clothing/lengha_choli}` },
                        { name: 'Sweaters', id: 'sweater', href: `{women/clothing/sweater}` },
                        { name: 'T-Shirts', id: 't-shirt', href: `{women/clothing/t-shirt}` },
                        { name: 'Jackets', id: 'jacket', href: `{women/clothing/jacket}` },
