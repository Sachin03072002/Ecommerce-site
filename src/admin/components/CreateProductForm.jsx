...
const CreateProductForm = () => {
  ...
  const renderThirdLevelCategorySelect = () => {
    const { topLevelCategory } = productData;
    if (topLevelCategory === "women") {
      return (
        ...
        <Grid item xs={12} sm={4}>
          <FormControl fullWidth>
            ...
            <Select
              ...
              label="Third Level Category"
            >
              <MenuItem value="mens_kurts">Mens Kurtas</MenuItem>
              <MenuItem value="shirt">Shirts</MenuItem>
              <MenuItem value="men_jeans">Men Jeans</MenuItem>
              <MenuItem value="sweater">Sewaters</MenuItem>
              <MenuItem value="t-shirt">T-Shirt</MenuItem>
              <MenuItem value="jacket">Jacket</MenuItem>
    ...
    <div className="p-10 overflow-x-hidden overflow-y-scroll h-[100vh]">
      ...
      >
        <Grid container spacing={2}>
          ...
          {renderThirdLevelCategorySelect()}
          <Grid item xs={12}>
            <TextField
              fullWidth
